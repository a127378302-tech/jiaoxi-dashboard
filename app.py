...
# [更新] Spring 檔期行銷活動表 (整合 Winter & Spring)
MARKETING_CALENDAR = {
    # --- 1月 ---
    "2026-01-01": "🎁 買飲料券送紅包袋 | 📱 LINE綁定贈好友分享",
    "2026-01-02": "☕ 新年好友分享日(BAF)",
    "2026-01-03": "⭐ 週末好星情(滿800贈8星)",
    "2026-01-04": "⭐ 週末好星情(滿800贈8星)",
    "2026-01-07": "🎫 金星好友分享(券) | 💳 OPENPOINT指定飲品10倍",
    "2026-01-08": "🎫 金星好友分享(券) | 💳 OPENPOINT指定飲品10倍",
    "2026-01-09": "🎫 金星好友分享(券) | 💳 OPENPOINT指定飲品10倍",
    "2026-01-10": "⭐ 週末好星情(滿800贈8星)",
    "2026-01-11": "⭐ 週末好星情(滿800贈8星)",
    "2026-01-12": "☕ 指定飲料好友分享",
    "2026-01-13": "🌟 金星雙倍贈星 | ☕ 指定BAF",
    "2026-01-14": "🧸 夾娃娃機加購開賣 | 🐼 foodpanda第二杯半價",
    ...
    "2026-01-31": "⭐ 週末好星情(滿800贈8星) | 🎫 兌換好友分享券",

    # --- 2月 (Spring檔期更新) ---
    "2026-02-01": "⭐ 週末好星情(滿800贈8星) | 🎫 兌換好友分享券",
    "2026-02-02": "☕ 尾牙BAF | 🎁 尾牙星送禮雙倍星",
    "2026-02-03": "☕ 尾牙BAF | 🎁 尾牙星送禮雙倍星",
    "2026-02-04": "🌟 金星雙倍贈星 | 🐼 foodpanda第二杯半價",
    "2026-02-05": "🐼 foodpanda第二杯半價",
    "2026-02-06": "🐼 foodpanda第二杯半價",
    "2026-02-07": "⭐ 週末好星情(滿800贈8星)",
    "2026-02-08": "⭐ 週末好星情(滿800贈8星)",
    "2026-02-09": "⭐ 星飲搶鮮(新品搶先喝) | 🌟 金星專屬星運抽",
    "2026-02-10": "⭐ 星飲搶鮮(新品搶先喝) | 🐼 foodpanda好友分享",
    "2026-02-11": "🎁 甜蜜情人節星送禮 | 🛵 foodomo雙杯組250元",
    "2026-02-12": "☕ 情人節快樂BAF",
    "2026-02-13": "☕ 情人節快樂BAF | 💳 OPENPOINT滿588贈66點",
    "2026-02-14": "🧧 馬歲喜臨門接喜卡(滿380贈1張)",
    "2026-02-15": "🧧 馬歲喜臨門接喜卡",
    "2026-02-16": "🧧 馬歲喜臨門接喜卡",
    "2026-02-17": "🧧 馬歲喜臨門接喜卡",
    "2026-02-18": "🧧 馬歲喜臨門接喜卡",
    ...
    "2026-02-21": "🧧 馬歲喜臨門接喜卡",
    "2026-02-22": "🧧 馬歲喜臨門接喜卡",
    "2026-02-23": "☕ 開工大吉BAF | 💳 OPENPOINT指定糕點10倍",
    "2026-02-24": "🐼 foodpanda第二杯半價",
    "2026-02-25": "🛵 foodomo星曜新年雙杯組230元 | 🛵 foodomo好友分享",
    "2026-02-26": "☕ 迎接連假出遊去BAF | 🛵 foodomo好友分享",
    "2026-02-27": "🛵 foodomo好友分享 | 🧧 接喜卡兌換開始",
    "2026-02-28": "🔴 228紀念日",

    # --- 3月 (Spring檔期預告) ---
    "2026-03-01": "♻️ 循環杯租借贈2顆星",
    "2026-03-02": "⭐ 早安好星情(飲+糕贈5星) | 🎁 寵愛女王星送禮",
    "2026-03-03": "⭐ 早安好星情(飲+糕贈5星) | 🐼 foodpanda好友分享",
    "2026-03-04": "⭐ 早安好星情(飲+糕贈5星)",
    "2026-03-05": "☕ 一起集氣BAF",
    "2026-03-06": "🎉 歡慶28週年購物派對(85折)",
    "2026-03-07": "⭐ 棒棒贏星Bonus Star | ⭐ 週末星夜Bonus Star",
    "2026-03-09": "☕ 感謝英雄BAF",
    "2026-03-11": "💳 OPENPOINT大杯飲料10倍 | 🛵 foodomo星光同慶雙杯210",
    "2026-03-13": "☕ 浪漫白色情人節BAF",
    "2026-03-18": "🌟 金星獨享好友分享(券) | 🐼 foodpanda第二杯半價",
    "2026-03-20": "🎉 歡慶28週年購物派對(85折)",
    "2026-03-23": "⭐ 星享成雙BAF",
    "2026-03-24": "⭐ 星享成雙BAF | 🐼 foodpanda好友分享",
    "2026-03-25": "🌟 金星專屬星運抽 | 🛵 foodomo一點折2元",
    "2026-03-26": "🌟 金星雙倍贈星",
    "2026-03-27": "☕ 歡慶28週年BAF",
}
...
def save_data(df, target="kpi"):
    try:
        ...
        if target == "kpi":
            ...
            str_cols = ['檔期', '品項名稱', '備註']
            for c in str_cols:
                save_df[c] = save_df[c].fillna("").astype(str)
...
with st.sidebar:
    ...
    page = st.radio("前往頁面", ["☕ 營運戰情室 (業績/禮盒)", "🗓️ 夥伴休假追蹤"])
...
if page == "☕ 營運戰情室 (業績/禮盒)":
    ...
    with tab3:
        st.markdown("#### 🎁 節慶禮盒與商品控管 (直覺輸入版)")
        
        if df_fest is None:
            st.warning("⚠️ 尚未偵測到 'Festival_Control' 分頁。請在下方新增資料並儲存。")
            cols = ['檔期', '品項名稱', '目標控量(總量)', '已訂貨(入庫)', '剩餘可訂量', '調入(+)', '調出(-)', '目前庫存(估)', '備註']
            display_fest_df = pd.DataFrame([["2026春節", "範例禮盒", 100, 0, 100, 0, 0, 0, ""]], columns=cols)
        else:
        ...
        edited_fest = st.data_editor(
            display_fest_df,
            column_config={
                "檔期": st.column_config.TextColumn("檔期 (例:2026春節)", width="medium", required=True),
    ...
    if col_save_2.button("🎁 更新禮盒 (Tab 3)"):
        save_data(edited_fest, "festival")
        st.session_state.df_fest = edited_fest
        st.rerun()
    ...
    with st.expander("點擊展開：取得 AI 深度分析指令 (高密度數據)", expanded=False):
...
"""
    ...
    st.header("🗓️ 夥伴休假管理 (建置中)")
    st.info("這裡將會是您的排班與休假管理介面。")
